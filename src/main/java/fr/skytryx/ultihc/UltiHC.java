...
@Plugin(name="UltiHC", version="1.0")
@Command(name="inspectmap", desc="inspectmap command")
@Command(name="reloadmap", desc="reloadmap command")
@Command(name="stats", desc="stats command")

public class UltiHC extends JavaPlugin {
